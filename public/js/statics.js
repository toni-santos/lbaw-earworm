...
function toggleFAQ(section, id) {
    ...
    const faq_content = document.querySelector(
        `#faq-drop-bot-${section}-${id} div`
    );
    const section_bot = document.querySelector(`#faq-section-bot-${section}`);
    ...
    if (faq_bot.style.maxHeight) {
        ...
        section_bot.style.maxHeight =
            faq_content.scrollHeight +
            36 +
            faq_bot.style.maxHeight.slice(0, -2) +
            "px";
