...
Route::get('/user/settings/recover-password/{id}', 'UserController@showRecoverPassword')->name('recoverpassword');
Route::post('/user/settings/recover-password/{id}', 'UserController@recoverPassword')->name('recoverPasswordPost');
